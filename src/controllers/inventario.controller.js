...
function CrearProducto() {
  ...
  function ValidateProductInputs() {
    ...
    if (codigo === "" || descripcion === "" || precioCompra === "" || precioVenta === "" || peso === "") {
...
function ValidateProviderInputs() {
  ...
  // Realiza la validación de los campos
  if (empresa === "" || nombreProveedor === "" || correo === "" || direccion === "" || telefono === "" || rfc === "") {
    alert("Por favor, completa todos los campos.");
    return false; // Detiene la ejecución de la función si algún campo está vacío
  }
  ...
  if (!telefonoRegex.test(telefono)) {
    alert("El número de teléfono no tiene un formato válido. Debe contener 10 dígitos.");
